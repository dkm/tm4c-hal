...
// SSI0
unsafe impl SckPin<SSI0> for PA2<AF2> {}
unsafe impl MisoPin<SSI0> for PA4<AF2> {}
unsafe impl MosiPin<SSI0> for PA5<AF2> {}

// SSI1
unsafe impl SckPin<SSI1> for PD0<AF2> {}
unsafe impl MisoPin<SSI1> for PD2<AF2> {}
unsafe impl MosiPin<SSI1> for PD3<AF2> {}

// SSI2
unsafe impl SckPin<SSI2> for PB4<AF2> {}
unsafe impl MisoPin<SSI2> for PB6<AF2> {}
unsafe impl MosiPin<SSI2> for PB7<AF2> {}

// SSI3
unsafe impl SckPin<SSI3> for PD0<AF1> {}
unsafe impl MisoPin<SSI3> for PD2<AF1> {}
unsafe impl MosiPin<SSI3> for PD3<AF1> {}
        ...
        $(
            impl<SCK, MISO, MOSI> Spi<$SPIX, (SCK, MISO, MOSI)> {
                    ...
                    MOSI: MosiPin<$SPIX>,
                {
                    ...
                    let mut scr: u8;
                    let mut cpsr = 2u8;
                    let target_bitrate = clocks.sysclk.0 / freq.into().0;
                    ...
                    loop {
                        scr = ((target_bitrate / cpsr as u32) - 1) as u8;
                        if scr < 255 {
                            break;
                        }
                        cpsr += 2;
